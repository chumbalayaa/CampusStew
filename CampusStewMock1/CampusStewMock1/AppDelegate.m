...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // ****************************************************************************
    [Parse setApplicationId:@"lHQNK8ps5exv7T6XleYDkleB4zwBnBKBnOTdRdpm"
                  clientKey:@"hyBFPGqKFR1WWmdWxTA3JLwcuSDqZ0eDlqWDgRxC"];
    ...
    //self.window.rootViewController = [[PFLogInViewController alloc] init];
